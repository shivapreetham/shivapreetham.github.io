      ...
      <div className="flex flex-col sm:flex-row items-start gap-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Computer Science undergraduate at NIT Jamshedpur — software engineer and machine learning researcher.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            <Link
              href="/projects"
              className="text-sm px-3 py-1.5 rounded border border-border hover:border-foreground/30"
            >
              View projects
            </Link>
            <Link
          ...
          <div className="flex gap-4 mt-5 text-muted-foreground">
            <a href={SOCIAL_LINKS.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <Github size={18} className="hover:text-foreground transition-colors" />
            </a>
            <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <Linkedin size={18} className="hover:text-foreground transition-colors" />
            </a>
